  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-800">
      ...
      <ScrollView className="flex-1 bg-slate-900">
          ...
          <View className="items-center py-6 bg-slate-900">
            ...
            <View className="flex-row justify-around w-full mt-4 py-4">
              ...
              <View className="items-center">
                ...
                <Text className="text-xs text-slate-500 uppercase">Released</Text>
              </View>
            </View>
        </View>
        ...
        <View className="p-6">
          <Text className="text-blue-800 font-bold text-2xl mb-2" style={{ color: currentGenre.color }}>Quotes</Text>
          <View className="bg-slate-800 p-3 rounded-lg gap-4">
            <Text className="italic font-semibold" style={{ color: currentGenre.color }}>
